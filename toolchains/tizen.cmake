...
STRING(REGEX REPLACE "([^ ]*)-([^ ]*)" "\\1" __tizen_platform ${TIZEN_TARGET})         # mobile
STRING(REGEX REPLACE "([^ ]*)-([^ ]*)" "\\2" __tizen_platform_version ${TIZEN_TARGET}) # 4.0
...
endif(TIZEN_TARGET STREQUAL "wearable-3.0")
